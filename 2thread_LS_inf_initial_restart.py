...
class r0123456:  # 主求解类（类名应改为学号）
    ...
    def optimize(self, filename: str):  # 主优化入口
        ...
        strat_probs = np.array([0.5, 0.3, 0.2], dtype=np.float64)
...
if __name__ == "__main__":  # 脚本入口
    ...
    ea = r0123456(N_RUNS=10000000, lam=300, mutation_rate=0.7, k_tournament=2, mu=2000, local_rate=0.2, ls_max_steps=30, stagnation_limit=25)  # 停滞150代后触发灾变重启

    ea.optimize("tour750.csv")  # 运行优化并输出进度